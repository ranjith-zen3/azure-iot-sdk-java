...
public class X509ThumbprintParser
{
    ...
    private static final String NULL_OR_EMPTY_JSON_ARGUMENT_ERROR_MESSAGE = "The provided Json must not be null or empty";
    private static final String INVALID_JSON_ERROR_MESSAGE = "The provided json could not be parsed";
    private static final String PRIMARY_THUMBPRINT_NULL_OR_EMPTY_ERROR_MESSAGE = "Primary thumbprint cannot be null or empty";
    private static final String SECONDARY_THUMBPRINT_NULL_OR_EMPTY_ERROR_MESSAGE = "Secondary thumbprint cannot be null or empty";
    ...
    public X509ThumbprintParser(String json) throws IllegalArgumentException
    {
        ...
        {
            throw new IllegalArgumentException(NULL_OR_EMPTY_JSON_ARGUMENT_ERROR_MESSAGE);
        }
    ...
    public void setPrimaryThumbprint(String primaryThumbprint) throws IllegalArgumentException
    {
        ...
        {
            throw new IllegalArgumentException(PRIMARY_THUMBPRINT_NULL_OR_EMPTY_ERROR_MESSAGE);
        }
    ...
    public void setSecondaryThumbprint(String secondaryThumbprint) throws IllegalArgumentException
    {
        ...
        {
            throw new IllegalArgumentException(SECONDARY_THUMBPRINT_NULL_OR_EMPTY_ERROR_MESSAGE);
        }
