...
public class SymmetricKeyParser
{
    ...
    private static final String MISSING_KEY_ERROR_MESSAGE = "Both the primary key and secondary key must be present and have a value in the provided json.";
    ...
    public SymmetricKeyParser(String json)
    {
                ...
                || parser.getSecondaryKey().isEmpty())
        {
            ...
            throw new IllegalArgumentException(MISSING_KEY_ERROR_MESSAGE);
        }
    ...
    public void setSecondaryKey(String secondaryKey) throws IllegalArgumentException
    {
        ...
        {
            throw new IllegalArgumentException("secondaryKey");
        }
