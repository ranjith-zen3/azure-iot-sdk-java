...
public class X509Thumbprint
{
    ...
    private static final String NULL_THUMBPRINT_MESSAGE = "Invalid format for primary/secondary thumbprint: thumbprint may not be null";
    private static final String EMPTY_THUMBPRINT_MESSAGE = "Invalid format for primary/secondary thumbprint: thumbprint may not be empty";
    private static final String INVALID_THUMBPRINT_MESSAGE = "Invalid format for primary/secondary thumbprint";
     ...
     */
    protected X509Thumbprint(String primaryThumbprint, String secondaryThumbprint)
    {
    ...
    protected String getPrimaryThumbprint()
    {
    ...
    protected String getSecondaryThumbprint()
    {
     ...
     * @throws IllegalArgumentException if the provided thumbprint is an invalid format
     */
    protected void setPrimaryThumbprint(String primaryThumbprint) throws IllegalArgumentException
    {
     ...
     * @throws IllegalArgumentException if the provided thumbprint is an invalid format
     */
    protected void setSecondaryThumbprint(String secondaryThumbprint) throws IllegalArgumentException
    {
    ...
    private void validateThumbprint(String thumbprint) throws IllegalArgumentException
    {
        if (thumbprint == null)
        {
            throw new IllegalArgumentException(NULL_THUMBPRINT_MESSAGE);
        }

        if (thumbprint.isEmpty())
        {
            throw new IllegalArgumentException(EMPTY_THUMBPRINT_MESSAGE);
        }
